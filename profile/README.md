...
|-------- |--------|---------- | -------- |
| Community | $0 USD per seat/year | AGPL-3.0 | Full Features |
| Business | $150 USD per seat/year | Commercial | Full Features |
| Fortune Global 500 | $5,000 USD per seat/year | Commercial | Full Features |
| GAMMA(Google, Apple, Microsoft, Meta, Amazon) | $1 billion USD a year | Commercial | Full Features |

- **AGPL-3.0 License**:
  - The GNU Affero General Public License is a free, copyleft license for software and other kinds of works, specifically designed to ensure cooperation with the community in the case of network server software.
- **Commercial License**:
  - For businesses that want to keep proprietary code private. [BUY NOW](https://opencollective.com/escss)
